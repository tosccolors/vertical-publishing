...
class AccountConfigSettings(models.TransientModel):
    ...
    def onchange_company_id(self):
        ...
        if self.company_id:
            ...
            susbcription_journal_id = ir_values.get_default('subscription.prepaid', 'susbcription_journal_id', company_id = self.company_id.id)
            ...
            self.susbcription_journal_id = susbcription_journal_id if susbcription_journal_id else False
        return res
    ...
    def set_product_susbcription_account(self):
        ...
        ir_values_obj.sudo().set_default('subscription.prepaid', "susbcription_journal_id", self.susbcription_journal_id.id if self.susbcription_journal_id else False, for_all_users=True, company_id=self.company_id.id)
